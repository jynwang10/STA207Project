...
<!-- ```{r,fig.cap='Box plot for math score',fig.pos='H',out.width = '.99\\linewidth',fig.height=3,fig.align="center"} -->
<!-- plot(math~star, dat1,cex.lab=0.8,cex.axis=0.8) # box plot for math score -->
<!-- ``` -->
